...
public class Valid10 {
	...
	private static String TIPO_DOCUMENTO = "PV";
	private static int CANTIDAD_CAMPOS = 14;
	...
	public static Response isValid10(Trx venta) {
...
//		System.out.println("canal "+trxId[1].subSequence(0, 2));
		...
		if (trxId[13].length() > LARGO_MARC_PDCTO) {
			logger.error("Marca de productos inválida: " + trxId[13]);
			message.setResponseError("35", "Marca de productos inválida: " + trxId[13]);
			return message;
		}
